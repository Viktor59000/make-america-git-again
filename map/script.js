...
// Country name to URL mapping for navigation
const countryLinks = {
    "France": "../francais/",
...
// Handle click on country to navigate to its page
function handleCountryClick() {
    const currentCountryName = svgCountries[hoveredCountryIdx]?.getAttribute("data-name");
    if (currentCountryName && countryLinks[currentCountryName]) {
        window.location.href = countryLinks[currentCountryName];
    }
}
